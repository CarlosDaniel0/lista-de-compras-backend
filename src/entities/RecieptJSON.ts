import { ProductRecieptImport } from "./ProductRecieptImport";

export class RecieptImport {
  id: string;
  name: string;
  user_id: string;
  ...
  constructor(
    ...
    if (products) this.products = products.map(ProductRecieptImport.parse);
  }
